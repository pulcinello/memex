    ...
    this.install = function () {
      ...
      for (var i = 0; i < this.keys.length; i++) {
        content += `<div class="row">
                      ...
                      }">${this.elementList[this.keys[i]].desc}</div>
                      <input placeholder="${
                        this.elementList[this.keys[i]].key
                      }" id="${this.elementList[this.keys[i]].key}">
                    </div>`;
      }
      content += `</form>`;
      ...
      for (var i = 0; i < this.keys.length; i++) {
        ...
        this.elementList[this.keys[i]].elemKey = document.getElementById(
      ...
      for (var i = 0; i < parent.keys.length; i++) {
        if (e.target.id == parent.elementList[parent.keys[i]].key) {
          if (!parent.elementList[parent.keys[i]].added) {
            ...
            parent.elementList[parent.keys[i]].elemKey.style.visibility =
              "visible";
          }
          break;
        }
      ...
      for (var i = 0; i < parent.keys.length; i++) {
        if (parent.elementList[parent.keys[i]].key == "Title") {
          if (parent.elementList[parent.keys[i]].elem.value != "") {
            value +=
              parent.elementList[parent.keys[i]].elem.value.toUpperCase();
          } else {
            value += "TITLE";
          }
          ...
          if (parent.elementList[parent.keys[i]].type == "lower") {
            value +=
              parent.elementList[parent.keys[i]].elem.value.toLowerCase();
            ...
            value +=
              parent.elementList[parent.keys[i]].elem.value.toProperCase();
